...
const themesMap = new Map([
  ["dark", {
    ...
    channelBgImg: 'url(images/channel-bg-dark.png)',
  ...
  ["light", {
    ...
    channelBgImg: 'url(images/channel-bg-light.png)',
    ...
    logoGlow: 'drop-shadow(1px 1px 0 rgba(250, 204, 135, 0.2))drop-shadow(-1px -1px 0 rgba(250, 233, 135, 0.2))drop-shadow(0 0 25px rgba(250, 229, 135, 0.5))',
    logoGlowHover: 'drop-shadow(1px 1px 0 rgba(250, 223, 135, 0.5))drop-shadow(-1px -1px 0 rgba(250, 229, 135, 0.5))drop-shadow(0 0 25px rgba(250, 219, 135, 0.9))',
...
export const updateTheme = (themeId) => {
  ...
  const { mainBg, promoBg, inputBg, btnBg, btnScrollBg, activeFirstBtnBg, activeBtnBg,
    ...
    fontLogo, fontPrimary, fontSecondary, fontTertiary, categoryBgImg, channelBgImg, channelBgImgTint, categoryBgImgTint, notFoundBgImg, notFoundBgImgTint, logoGlow, logoGlowHover, searchIcon, arrowDown, followBtn, subscribeBtn, crowdIcon, streamsNotFound } = themesMap.get(themeId);
