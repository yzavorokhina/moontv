                    ...
                    <div className="categories-container">
                        <div className="categories-titles-row">
                            ...
                            <div className="sorting-buttons">
                                <span class="sorting-text">Сортировка по:</span>
                                <button class="sorting-btn">
                                    ...
                                    <span class="btn-text">Названию</span>
                                </button>
                                <button class="sorting-btn">
                                    ...
                                    <span class="btn-text">Кол-ву зрителей</span>
                                </button>
                                <button class="sorting-btn">
                                    ...
                                    <span class="btn-text">Кол-ву просмотров</span>
                                </button>
                                <button class="sorting-btn">
                                    ...
                                    <span class="btn-text">Времени</span>
                                </button>
                            </div>
                        </div>
